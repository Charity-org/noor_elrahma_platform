...
const SocialBoxIcons = () => {
  const style =
    "w-5 h-5 fill-current text-white group-hover:text-white/90 transition-colors duration-300";

  const sociealData = [
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={style}>
    ...
    {
      icon: (
        <svg className={style} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
