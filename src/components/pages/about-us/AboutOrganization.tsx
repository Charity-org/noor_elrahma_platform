            ...
            >
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="font-bold text-2xl font-teachers text-black">
                    {typeof title === "string" ? title : locale === "ar" ? title.ar : title.en}
                  </h3>
                </div>
                  ...
                  {list && (
                    <ul className="list-disc space-y-2 text-[#595959] leading-relaxed text-base font-inter pl-4 marker:text-[#595959]">
                      {Array.isArray(list)
                        ...
                        : (locale === "ar" ? list.ar : list.en || []).map(
                            (li: string, i: number) => <li key={i}>{li}</li>,
                          )}
                    </ul>
                  )}
                </div>
